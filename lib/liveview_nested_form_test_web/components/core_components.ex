defmodule LiveviewNestedFormTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewNestedFormTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewNestedFormTestWeb.Gettext, "errors", msg, opts)
    end
  end
